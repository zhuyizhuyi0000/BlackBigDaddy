...
public class AjaxRecommendSteps {
	@AssertStepMethodDesc(description = "recommend game", owner = "tingwei.zhu")
	public void ajaxRecommend(String parameterID, String expectresult,
		...
		for (int i = 0; i < sqlresult.size() - 1; i++) {
			...
			Assert.assertEquals(rc.getJsonStringValue(i, "games", actualresult, "id"),rc.getListValue(i + 1, sqlresult, "gameId")
					);
		}
