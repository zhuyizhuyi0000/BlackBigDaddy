...
public class MemberStoreQueryHistorySteps {
	@AssertStepMethodDesc(description = "Member__order_queryHistory", owner = "xiuping.qi")
	public void memberStoreQueryHistory(String parameterID, String expectresult,
