...
public class dt_JFrame_fb extends JFrame {
	 ...
	 */
	public dt_JFrame_fb() throws HeadlessException
		{
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(panel_zc, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(panel_yc, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(panel_tj, 0, 0, Short.MAX_VALUE)
						.addComponent(panel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(panel_jd, GroupLayout.PREFERRED_SIZE, 251, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(panel_pt, GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE)
						.addComponent(panel_kl, GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE)
						.addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE)
						.addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE))
					.addContainerGap())
		);
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
						.addComponent(panel_kl, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 136, GroupLayout.PREFERRED_SIZE)
		...
		table_can.getColumnModel().getColumn(0).setMinWidth(160);
		table_can.getColumnModel().getColumn(0).setMaxWidth(160);
		table_can.getColumnModel().getColumn(1).setPreferredWidth(80);
		table_can.getColumnModel().getColumn(1).setMinWidth(80);
		table_can.getColumnModel().getColumn(1).setMaxWidth(80);
		table_can.getColumnModel().getColumn(2).setPreferredWidth(160);
		table_can.getColumnModel().getColumn(2).setMinWidth(160);
		table_can.getColumnModel().getColumn(2).setMaxWidth(160);
		table_can.getColumnModel().getColumn(3).setPreferredWidth(60);
		table_can.getColumnModel().getColumn(3).setMinWidth(60);
		table_can.getColumnModel().getColumn(3).setMaxWidth(60);
		table_can.getColumnModel().getColumn(4).setPreferredWidth(30);
		table_can.getColumnModel().getColumn(4).setMinWidth(30);
		table_can.getColumnModel().getColumn(4).setMaxWidth(30);
		...
		table_gwgw.getColumnModel().getColumn(0).setMinWidth(160);
		table_gwgw.getColumnModel().getColumn(0).setMaxWidth(160);
		table_gwgw.getColumnModel().getColumn(1).setPreferredWidth(80);
		table_gwgw.getColumnModel().getColumn(1).setMinWidth(80);
		table_gwgw.getColumnModel().getColumn(1).setMaxWidth(80);
		table_gwgw.getColumnModel().getColumn(2).setPreferredWidth(160);
		table_gwgw.getColumnModel().getColumn(2).setMinWidth(160);
		table_gwgw.getColumnModel().getColumn(2).setMaxWidth(160);
		table_gwgw.getColumnModel().getColumn(3).setPreferredWidth(60);
		table_gwgw.getColumnModel().getColumn(3).setMinWidth(60);
		table_gwgw.getColumnModel().getColumn(3).setMaxWidth(60);
		table_gwgw.getColumnModel().getColumn(4).setPreferredWidth(30);
		table_gwgw.getColumnModel().getColumn(4).setMinWidth(30);
		table_gwgw.getColumnModel().getColumn(4).setMaxWidth(30);
		...
		table_fpt.getColumnModel().getColumn(0).setMinWidth(160);
		table_fpt.getColumnModel().getColumn(0).setMaxWidth(160);
		table_fpt.getColumnModel().getColumn(1).setPreferredWidth(80);
		table_fpt.getColumnModel().getColumn(1).setMinWidth(80);
		table_fpt.getColumnModel().getColumn(1).setMaxWidth(80);
		table_fpt.getColumnModel().getColumn(2).setPreferredWidth(160);
		table_fpt.getColumnModel().getColumn(2).setMinWidth(160);
		table_fpt.getColumnModel().getColumn(2).setMaxWidth(160);
		table_fpt.getColumnModel().getColumn(3).setPreferredWidth(60);
		table_fpt.getColumnModel().getColumn(3).setMinWidth(60);
		table_fpt.getColumnModel().getColumn(3).setMaxWidth(60);
		table_fpt.getColumnModel().getColumn(4).setPreferredWidth(30);
		table_fpt.getColumnModel().getColumn(4).setMinWidth(30);
		table_fpt.getColumnModel().getColumn(4).setMaxWidth(30);
