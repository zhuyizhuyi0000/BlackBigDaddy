...
public class Util {
	 ...
	 * 游戏厂商接收百度游戏成功订单通知的地址
	 */
	public final static String RECEIVIE_ORDER_URL = "http://bb-game-test09.vm.baidu.com:8080/receiveOrderServlet";
	 ...
	 * POST角色rest接口地址
	 */
	public final static String ROLE_REST_URL = "http://youxi.baidu.com/game_role_rest";
