...
toAdd = ['qixiuping@baidu.com','zhujinling@baidu.com']  #收件人
...
def getGameIdList():
    ...
    letter_list = ["ABC","DEFG","HIJK","LMNO","PQRST","UVWX","YZ"]
...
def getDataDict():
    data_list = []
    #gameId_list = [920]
    gameId_list = [177, 249, 429, 653, 724, 727, 776, 852, 899, 949, 255, 322, 349, 399, 421, 434, 495, 797, 842, 872, 234, 294, 482, 723, 798, 820, 833, 209, 355, 683, 808, 841, 341, 396, 441, 442, 736, 778, 805, 818, 853, 887, 254, 318, 414, 513, 705, 788, 825, 107, 191, 253, 359, 511, 631, 813, 894, 901, 916, 228, 202, 217, 242, 259, 266, 312, 335, 397, 439, 451, 478, 515, 637, 664, 689, 706, 708, 735, 737, 757, 761, 794, 829, 904, 274, 411, 444, 617, 766, 250, 262, 383, 716, 763, 769, 891, 237, 251, 281, 354, 415, 684, 839, 863, 870, 920, 921, 924, 573, 619, 305, 508, 791]
...
###################登录状态判断####################
def login():        
    type('youxi.baidu.com'+'\n')
    wait(1)
    while not exists("HiEi5E-2.png",8):       
            
        click("AH1BfIf1F-3.png")
        paste('koko110700') 
        type(Key.TAB)
        paste('qwe123')
        click("1413971242859-2.png")    
        wait(2)
        print("-------------------------------------------------------IndexLg,OK")        
...
if __name__ == '__main__':
    openApp("C:\Users\Administrator\AppData\Local\Google\Chrome\Application\chrome.exe")  #公用
    #openApp("C:\Program Files\Google\Chrome\Application\chrome.exe")   #koko
    wait(1)
    login()
    for index in range (0,time):       
        gameId = data_dict[index]['gameId']
        serverId = data_dict [index]['serverId']
        gameUrl='http://youxi.baidu.com/login_game_by_post.xhtml?id='+gameId+ '&serverId='+serverId   # 游戏页地址
