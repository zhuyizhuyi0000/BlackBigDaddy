	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		try {
            ...
            if(signature.equals(sign)){
            	request.setAttribute("msg1", userId);
            	request.setAttribute("msg2", serverId);
            	request.setAttribute("msg3", Util.API_KEY);
            	request.setAttribute("msg4", cmFlag);
            	request.setAttribute("msg5", timestamp);
            	request.setAttribute("msg6", sign);
